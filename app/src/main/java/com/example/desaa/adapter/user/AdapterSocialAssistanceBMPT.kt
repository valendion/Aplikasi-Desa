...
import com.example.desaa.databinding.ItemSimpleListBinding
...
class AdapterSocialAssistanceBMPT :
    ...
    inner class SocialAssitanceBMPT(val binding: ItemSimpleListBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SocialAssitanceBMPT {
        val itemBinding =
            ItemSimpleListBinding.inflate(LayoutInflater.from(parent.context))
